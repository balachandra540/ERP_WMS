                            ...
                            edit: {
                                ...
                                write: (args) => {
                                    ...
                                    const applyProductToObjs = (productId, product, qty = 1) => {
                                        ...
                                        if (typeof movementObj !== 'undefined' && movementObj) { movementObj.value = qty; }

                                        args.rowData.productId = productId;
                                        args.rowData.movement = qty;
                                    };

                                    // ── HELPER B: Recalculate persisted row data ─────────────
                                    const recalcRowData = (rowData, productId, newQty) => {
                                        rowData.movement = newQty;
                                    };
                                    ...
                                    const openAttributeModalWithAutoNext = async (rowData) => {
                                        ...
                                        // 🔥 Passed rowData as the second parameter so the modal logic executes flawlessly
                                    ...
                                    const processPLU = async (enteredPLU) => {
                                        ...
                                        try {
                                            ...
                                            if (duplicateRow) {
                                                ...
                                                const newQty = (parseFloat(duplicateRow.movement) || 0) + 1;
